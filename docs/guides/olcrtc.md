...
**Клиент:** Ядро **olcRTC**, платформа **WB Stream**, транспорт **DataChannel**. Введите ID комнаты WB Stream, ID клиента и ключ авторизации из шагов 3 и 4.

---

### 5.2 Профиль для Telemost

**Клиент:** Ядро **olcRTC**, платформа **Telemost**, транспорт **VP8Channel**. Введите ID комнаты Telemost, ID клиента и ключ авторизации из шагов 3 и 4.
